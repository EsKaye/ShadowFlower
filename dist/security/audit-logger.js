...
(function (AuditEventType) {
    ...
    AuditEventType["ADMIN_AUTH_SUCCESS"] = "admin_auth_success";
    AuditEventType["ADMIN_AUTH_FAILURE"] = "admin_auth_failure";
    AuditEventType["SIGNATURE_VERIFICATION_SUCCESS"] = "signature_verification_success";
    AuditEventType["SIGNATURE_VERIFICATION_FAILURE"] = "signature_verification_failure";
    AuditEventType["JOB_EXECUTION_SUCCESS"] = "job_execution_success";
    AuditEventType["JOB_EXECUTION_FAILURE"] = "job_execution_failure";
    AuditEventType["RATE_LIMIT_EXCEEDED"] = "rate_limit_exceeded";
    AuditEventType["CORS_REJECTED"] = "cors_rejected";
    AuditEventType["DISCORD_NOTIFICATION_SUCCESS"] = "discord_notification_success";
    AuditEventType["DISCORD_NOTIFICATION_FAILURE"] = "discord_notification_failure";
